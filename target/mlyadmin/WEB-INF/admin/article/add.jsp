				...
				<div class="portlet-body form">
					...
					<form action="#" id="articleForm" class="form-horizontal form-bordered form-row-stripped">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="title" placeholder="small" class="m-wrap span12">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">副标题</label>
							<div class="controls">
								<input type="text" name="shortTitle" placeholder="small" class="m-wrap span12">
							</div>
						</div>
						<div class="control-group">
...
<!-- END PAGE CONTAINER-->    
 <script type="text/javascript">
        ...
        $('#submit').click(function () {
            ...
            $.ajax({  
                 url: '${basePath}/admin/article/save' ,  
                 type: 'POST',  
                 data: formData,  
                 async: false,  
                 cache: false,  
