...
<div class="container-fluid">
	...
	<!-- END PAGE HEADER-->
	<div id="dashboard">
                       <h1 style="color:green">欢迎来到萌兔体验中心！</h1>
	</div>
	<!-- END PAGE HEADER-->
	<div class="row-fluid">
		<div class="portlet-body" style="display: block;">
			<table class="table table-striped table-bordered table-advance table-hover">
				...
				<tbody>
					<c:forEach var="member" items="${beans}"> 
					    <tr>
							<td><a href="#">${member.conundrum}</a></td>
							<%-- <td class="hidden-phone">${department.parentName}</td> --%>
							<td>${member.answer}</td>
							<%-- <td>${department.priority}</td> --%>
							<td><a class="btn mini green-stripe" href="${basePath}/admin/department/edit?departmentId=">编辑</a>|
							<a class="btn mini green-stripe" href="${basePath}/admin/department/delete?departmentId=">删除</a></td>
						</tr>
					</c:forEach>
