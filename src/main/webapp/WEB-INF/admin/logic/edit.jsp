						...
						<div class="row-fluid">
							<div class="span6 ">
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="logicName" value="${bean.logicName}" class="m-wrap span12" placeholder="Chee Kin">
									</div>
								</div>
							</div>
							<!--/span-->
							 <div class="span6 ">
								<div class="control-group">
									...
									<div class="controls">
										<input type="text"  name="semantic"  value="${bean.semantic}"  class="m-wrap span12" placeholder="dd/mm/yyyy">
									</div>
								</div>
							</div> 
							<!--/span-->
						...
						<div class="row-fluid">
							<div class="span6 ">
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="code" value="${bean.code}" class="m-wrap span12" placeholder="Chee Kin">
									</div>
								</div>
							</div>
							<div class="span6 ">
