...
<meta charset="utf-8" />
	...
	<link href="${basePath}/media/css/mstyle.css" rel="stylesheet" type="text/css"/>
	<link href="${basePath}/media/css/style-responsive.css" rel="stylesheet" type="text/css"/>
	<link href="${basePath}/media/css/mdefault.css" rel="stylesheet" type="text/css" id="style_color"/>
